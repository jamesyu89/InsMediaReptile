...
namespace InstagramPhotos.Utility.Extension
{
    ...
    public static class EnumerableExtensions
    {
        ...
        public static IEnumerable<KeyValuePair<T1, T2>> Zip<T1, T2>(this IEnumerable<T1> sequence1,
        ...
        public static IDictionary<TKey, TValue> ToDictionary<TKey, TValue>(this IEnumerable<TKey> keys,
