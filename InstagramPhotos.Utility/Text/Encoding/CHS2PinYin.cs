...
namespace InstagramPhotos.Utility.Text.Encoding
{
    ...
    public sealed class CHS2PinYin
    {
        ...
        ///     包含字符 ASC 码的整形数组。
        /// </summary>
        private static readonly int[] pv =
        {
        ...
        private static readonly string[] ps =
        {
            ...
            "nong", "nu", "nv", "nuan", "nue", "nuo", "o", "ou", "pa", "pai", "pan", "pang", "pao", "pei", "pen", "peng",
            "pi", "pian", "piao", "pie", "pin", "ping", "po", "pu", "qi", "qia", "qian", "qiang", "qiao", "qie", "qin",
            "qing", "qiong", "qiu", "qu", "quan", "que", "qun", "ran", "rang", "rao", "re", "ren", "reng", "ri", "rong",
            "rou", "ru", "ruan", "rui", "run", "ruo", "sa", "sai", "san", "sang", "sao", "se", "sen", "seng", "sha",
            ...
            "zei", "zen", "zeng", "zha", "zhai", "zhan", "zhang", "zhao", "zhe", "zhen", "zheng", "zhi", "zhong", "zhou",
            "zhu", "zhua", "zhuai", "zhuan", "zhuang", "zhui", "zhun", "zhuo", "zi", "zong", "zou", "zu", "zuan", "zui",
            "zun", "zuo"
        };
        ...
        public static string Convert(string chs, string separator, bool initialCap, bool isFull = true)
        {
        ...
        /// <returns></returns>
        public static string ConvertInitial(string chs)
        {
            return Convert(chs, string.Empty, false, false);
        }
        ...
        {
            return Convert(chs, separator, true);
        }
