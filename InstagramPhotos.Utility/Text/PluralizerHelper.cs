...
namespace InstagramPhotos.Utility.Text
{
    public class PluralizerHelper
    {
        ...
        private static readonly Dictionary<string, Word> _specialSingulars;
        private static readonly Dictionary<string, Word> _specialPlurals;
        private static readonly List<SuffixRule> _suffixRules;
