...
using InstagramPhotos.Utility.UmengPush.Core;

namespace InstagramPhotos.Utility.UmengPush
{
    /// <summary>
    /// 友盟消息推送
    /// </summary>
    public class UMengMessagePush : IPush, IDisposable
    {
        ...
        private const string taskPath = "api/status";
        ...
        public UMengMessagePush(string appkey, string appMasterSecret, string path)
        {
