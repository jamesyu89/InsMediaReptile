...
namespace InstagramPhotos.Utility.Utility
{
    ...
    public static class EmitHelper
    {
        ...
        {
            PropertyInfo info = typeof(T).GetProperty(Pname);
            //return info.GetValue(Source, null);
            return GetPropertyValue(info, Source);
        }
        public static object GetPropertyValue(PropertyInfo property, object target)
        {
            return EmitHelper.GetPropertyGetter(property).Invoke(target);
        }
